...
<div  class="red"; style="background-color:wheat" id="print4" >
	<div class="col-md">
		<hr>
		<h1>
			<a class="btn btn-outline-info  btn-sm btn-block"; style="background-color:orangered; text-transform: uppercase;" > <b>Liste des mesures</b> </a>
		</h1>
...
<div class="lightblue">
	<div class="col-md">
		...
		<h2>
			<a class="btn btn-outline-info  btn-sm btn-block"; style="background-color:seagreen; " > <b>DATE DU DERNIER AUDIT SUR LES MESURES DE L'ANNXE A
