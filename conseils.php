...
<div class="red" >
	<div class="col-md">
			<hr>
			<h1>
				<a class="btn btn-outline-info  btn-sm btn-block"; style="background-color:#ff6f06" > <b>Quelques CONSEILS pour atteindre le respect des exigences...</b> </a>
			</h1>
	</div>
</div>
<!--etiquette de conseils-->
...
<table border=4 cellspacing=4 cellpadding=4 width=80%>
   ...
   <tr>
       <td colspan="3"; style="background-color:Aqua"> Art. 6    Planification  </td>
   </tr>
   <tr>
       <td>
           <ul>
