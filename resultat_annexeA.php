...
<div  class="red"; style="background-color:wheat" id="print4" >
	<div class="col-md">
		...
		<h1 style="width: 100%; text-align: center;">
			<a class="btn btn-outline-info  btn-sm btn-block"; style="background-color:#ff6f06; text-transform: uppercase;"> <b>Liste des mesures</b> </a>
		</h1>
...
<div class="lightblue">
	<div class="col-md">
		...
		<h2>
			<a class="btn btn-outline-info  btn-sm btn-block"; style="background-color:blue " > <b>DATE DU DERNIER AUDIT SUR LES MESURES DE L'ANNXE A
